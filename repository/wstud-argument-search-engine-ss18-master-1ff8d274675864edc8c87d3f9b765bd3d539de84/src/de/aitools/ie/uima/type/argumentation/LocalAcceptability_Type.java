 ...
 * @generated */
public class LocalAcceptability_Type extends Classification_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = LocalAcceptability.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.aitools.ie.uima.type.argumentation.LocalAcceptability");
  ...
  public double getMajority(int addr) {
      ...
      jcas.throwFeatMissing("majority", "de.aitools.ie.uima.type.argumentation.LocalAcceptability");
  ...
  public double getMean(int addr) {
      ...
      jcas.throwFeatMissing("mean", "de.aitools.ie.uima.type.argumentation.LocalAcceptability");
  ...
  public int getAllScores(int addr) {
      ...
      jcas.throwFeatMissing("allScores", "de.aitools.ie.uima.type.argumentation.LocalAcceptability");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public LocalAcceptability_Type(JCas jcas, Type casType) {
    super(jcas, casType);
