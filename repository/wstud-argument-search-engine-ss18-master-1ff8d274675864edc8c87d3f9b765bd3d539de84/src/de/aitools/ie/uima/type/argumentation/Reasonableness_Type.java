 ...
 * @generated */
public class Reasonableness_Type extends Classification_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Reasonableness.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.aitools.ie.uima.type.argumentation.Reasonableness");
  ...
  public double getMajority(int addr) {
      ...
      jcas.throwFeatMissing("majority", "de.aitools.ie.uima.type.argumentation.Reasonableness");
  ...
  public double getMean(int addr) {
      ...
      jcas.throwFeatMissing("mean", "de.aitools.ie.uima.type.argumentation.Reasonableness");
  ...
  public int getAllScores(int addr) {
      ...
      jcas.throwFeatMissing("allScores", "de.aitools.ie.uima.type.argumentation.Reasonableness");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Reasonableness_Type(JCas jcas, Type casType) {
    super(jcas, casType);
