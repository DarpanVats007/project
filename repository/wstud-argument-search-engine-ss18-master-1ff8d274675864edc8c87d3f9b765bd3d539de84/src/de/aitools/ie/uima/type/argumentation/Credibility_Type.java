 ...
 * @generated */
public class Credibility_Type extends Classification_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Credibility.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.aitools.ie.uima.type.argumentation.Credibility");
  ...
  public double getMajority(int addr) {
      ...
      jcas.throwFeatMissing("majority", "de.aitools.ie.uima.type.argumentation.Credibility");
  ...
  public double getMean(int addr) {
      ...
      jcas.throwFeatMissing("mean", "de.aitools.ie.uima.type.argumentation.Credibility");
  ...
  public int getAllScores(int addr) {
      ...
      jcas.throwFeatMissing("allScores", "de.aitools.ie.uima.type.argumentation.Credibility");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public Credibility_Type(JCas jcas, Type casType) {
    super(jcas, casType);
