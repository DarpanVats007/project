 ...
 * @generated */
public class ArgumentativeDiscourseUnit_Type extends Unit_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = ArgumentativeDiscourseUnit.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.aitools.ie.uima.type.argumentation.ArgumentativeDiscourseUnit");
  ...
  public String getUnitType(int addr) {
      ...
      jcas.throwFeatMissing("unitType", "de.aitools.ie.uima.type.argumentation.ArgumentativeDiscourseUnit");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public ArgumentativeDiscourseUnit_Type(JCas jcas, Type casType) {
    super(jcas, casType);
