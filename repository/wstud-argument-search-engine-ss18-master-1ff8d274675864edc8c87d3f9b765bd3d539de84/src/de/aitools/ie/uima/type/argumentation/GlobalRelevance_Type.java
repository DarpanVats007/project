 ...
 * @generated */
public class GlobalRelevance_Type extends Classification_Type {
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = GlobalRelevance.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.aitools.ie.uima.type.argumentation.GlobalRelevance");
  ...
  public double getMajority(int addr) {
      ...
      jcas.throwFeatMissing("majority", "de.aitools.ie.uima.type.argumentation.GlobalRelevance");
  ...
  public double getMean(int addr) {
      ...
      jcas.throwFeatMissing("mean", "de.aitools.ie.uima.type.argumentation.GlobalRelevance");
  ...
  public int getAllScores(int addr) {
      ...
      jcas.throwFeatMissing("allScores", "de.aitools.ie.uima.type.argumentation.GlobalRelevance");
  ...
  /** initialize variables to correspond with Cas Type and Features
	 ...
	 * @param casType Type 
	 */
  public GlobalRelevance_Type(JCas jcas, Type casType) {
    super(jcas, casType);
